...
if (!window.jscolor) {
    ...
    window.jscolorEventChange = null;
    ...
    window.jscolor = (function() {
        ...
        var jsc = {
            ...
            tryInstallOnElements: function(elms, className) {
                ...
                for (var i = 0; i < elms.length; i += 1) {
                    ...
                    if (!elms[i].jscolor && elms[i].className && (m = elms[i].className.match(matchClass))) {
                        ...
                        targetElm.jscolor = new jsc.jscolor(targetElm, {});
                    }
                }
            },
            ...
            dispatchFineChange: function(thisObj) {
                if (window.jscolorEventChange !== null)
                    window.jscolorEventChange(thisObj);
                else if (thisObj.onFineChange) {
                    var callback;
